...
import {
  callbackRouteForApi,
  callbackRouteForCallbackHell,
  callbackRouteForFAkeApi,
} from "./utils/AsyncPatterns/callback.js";
import {
  promiseRouteForApi,
  promiseRouteForFAkeApi,
} from "./utils/AsyncPatterns/promise.js";
import {
  asyncRouteForApi,
  asyncRouteForFAkeApi,
} from "./utils/AsyncPatterns/async.js";
