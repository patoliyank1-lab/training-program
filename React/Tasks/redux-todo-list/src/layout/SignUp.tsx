...
import { storeData, findUserByEmail, findUserByUsername, setCurrentUser } from '../utils/userData'
...
export default function SignUp() {
  ...
  const onSubmit = () => {
    ...
    if (!fullName.isError && !number.isError && !email.isError && !username.isError && !password.isError && !confirmPassword.isError) {
      const user = storeData(fullName.value, email.value, countryCode + number.value, username.value, password.value)
      if(user){
