...
const Sidebar = ({ onTaskAdded, onPriorityChange, selectedPriority, onStatusChange, selectedStatus }: {
  onTaskAdded?: () => void;
  ...
  return (
    <>
      <div className="bg-white shadow-sm w-full md:w-64 flex-shrink-0 h-full overflow-y-auto p-4 border-r border-gray-200">
        {/* Add Task Button */}
        <div>
          <div
      ...
      <AddTask visible={isVisible} onClose={() => setIsVisible(false)} onTaskAdded={onTaskAdded} />
    </>
  );
};
