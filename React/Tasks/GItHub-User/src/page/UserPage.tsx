...
export default function UserPage() {
    ...
    return (
        <>
            {/* User Not Found Page */}
            {userNotFound && (
                <div className={`h-screen w-full flex justify-center items-center ${theme === 'dark' ? 'bg-body' : 'bg-gray-100'}`}>
                    <div className="flex flex-col items-center justify-center p-8">
                        <h1 className={`text-4xl md:text-5xl font-bold mb-4 ${theme === 'dark' ? 'text-gray-200' : 'text-gray-800'}`}>
                            User Not Found
                        </h1>
                    </div>
                </div>
